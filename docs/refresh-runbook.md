...
- BLS may reject a hosted runner's calendar request. This is a source-check failure, not a new calendar: keep the verified file, report the failure, and retain the review artifact for inspection. Do not work around an access restriction or relabel cached dates as freshly checked.
